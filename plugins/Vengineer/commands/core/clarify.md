...
argument-hint: "[feature description or context to clarify]"
...
**Goal:** Detect and reduce ambiguity in feature requests by asking up to 5 highly targeted clarification questions using the AskUserQuestion tool. After clarification, append the results to the plan file.
